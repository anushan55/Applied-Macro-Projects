...
input <- 'project_varcreation_svydesign.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)

input <- 'project_varcreation_treatments_2.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)
...
input <- 'project_samplecreation_main_india.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)

input <- 'project_samplecreation_main_africa.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)

input <- 'project_samplecreation_main_lac.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)

input <- 'project_samplecreation_main_asia.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)

input <- 'project_samplecreation_main_svydesign.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)

input <- 'project_samplecreation_main_2.R'
source(paste0(DO,input,sep=""), echo=TRUE, max=1000)
...
##########################################################
input<- 'project_analysis_inequality_gini and lorenz.R'
source(paste0(DO,input,sep=""), echo = TRUE, max=1000)
