...
pred_future_france[,"hs"]<-0.2333287
...
SAVE(dfx=pred_future_all_france, namex ="pred_future_all_france_constantedu")
...
SAVE(dfx=pred_future_developed_france, namex ="pred_future_developed_france_constantedu")
...
pred_future_germany[,"hs"]<-0.2029679
...
SAVE(dfx=pred_future_all_germany, namex ="pred_future_all_germany_constantedu")
...
SAVE(dfx=pred_future_developed_germany, namex ="pred_future_developed_germany_constantedu")
...
SAVE(dfx=pred_future_all_india, namex ="pred_future_all_india_constantedu")
...
SAVE(dfx=pred_future_developing_india, namex ="pred_future_developing_india_constantedu")
...
SAVE(dfx=pred_future_all_sl, namex ="pred_future_all_sl_constantedu")
...
SAVE(dfx=pred_future_developing_sl, namex ="pred_future_developing_sl_constantedu")
